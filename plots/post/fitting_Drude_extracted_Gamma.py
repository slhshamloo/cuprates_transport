...
axis.legend(loc = 4, ncol=2, fontsize = 16, frameon = True, numpoints=1, markerscale = 1, handletextpad=0.5)

######################################################
#############################################
axis.set_xlim((-1.4,40))   # limit for xaxis
axis.set_ylim((0,3))   # limit for xaxis
# axs.set_xscale('log')
# axs.set_yscale('log')

axis.set_ylabel(r"$\frac{\Gamma}{2\pi}$ ( THz )", labelpad = 8)
