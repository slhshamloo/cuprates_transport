...
######################################################
legend_els = [Line2D([0], [0], ls="", marker='o', color='black', label='Normal',
                          markerfacecolor='black', markersize=15),
              Line2D([0], [0], ls="", marker='*', color='black', label='Superconducting',
                          markerfacecolor='black', markersize=15)]
axis.legend(handles=legend_els, loc = 5, fontsize = 16, frameon = True, numpoints=1, markerscale = 1, handletextpad=0.5)

######################################################
#############################################
axis.set_xlim((-1.4,40))   # limit for xaxis
axis.set_ylim((-2*1e3,65*1e3))   # limit for xaxis
# axs.set_xscale('log')
# axs.set_yscale('log')

axis.set_ylabel(r"$(\omega_p/2\pi)^2$ ( THz$^2$ )", labelpad = 8)
